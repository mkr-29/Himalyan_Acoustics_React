    ...
    <div className="temp1">
      <div className="temp1_body">
        ...
        <div className="temp1_imgsec">
          ...
          <div className="temp1_imgcard">
            <img src={parse.img21} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt21}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img22} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt22}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img23} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt23}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img24} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt24}</h3>
          </div>

          <div className="temp1_imgcard">
            <img src={parse.img25} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt25}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img26} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt26}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img27} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt27}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img28} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt28}</h3>
          </div>

          <div className="temp1_imgcard">
            <img src={parse.img29} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt29}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img30} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt30}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img31} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt31}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img32} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt32}</h3>
          </div>

          <div className="temp1_imgcard">
            <img src={parse.img33} className="temp1_img" alt='' />
            <h3 className="temp1_imgtitle">{parse.imgt33}</h3>
          </div>
          <div className="temp1_imgcard">
            <img src={parse.img34} className="temp1_img" alt='' />
